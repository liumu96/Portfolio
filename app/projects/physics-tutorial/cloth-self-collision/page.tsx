...
const CannonBall3D = () => {
  ...
  useEffect(() => {
    if (canvasRef.current) {
      ...
      threeScene.addSelfCollisionCloth();
      threeScene.camera?.position.set(0, 1.0, 0.5);
      threeScene.cameraControl.target.y = 0.0;
  ...
  useEffect(() => {
    if (threeScene) {
      threeScene.physicsScene.cloth.bendingCompliance = compliance;
    }
  }, [compliance]);
